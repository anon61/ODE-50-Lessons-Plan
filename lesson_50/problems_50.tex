...
\textbf{Problem 1:}
- $y$_{1}$ = 1 + 0.1(0 - 1) = 0.9$
- $y$_{2}$ = 0.9 + 0.1(0.1 - 0.9) = 0.82$
- $y$_{3}$ = 0.82 + 0.1(0.2 - 0.82) = 0.758$

\textbf{Problem 4:} For stability: $|1 - 10h| < 1$, so $h < 0.2$

\textbf{Problem 9:} RK4 for $y' = x$^{2}$ + y$^{2}$$:
- $k$_{1}$ = 0$
- $k$_{2}$ = 0.5(0.25)$^{2}$ = 0.03125$
- $k$_{3}$ = 0.5[(0.25)$^{2}$ + (0.0156)$^{2}$] \approx 0.0312$
- $k$_{4}$ = 0.5[(0.5)$^{2}$ + (0.0312)$^{2}$] \approx 0.125$
- $y$_{1}$ \approx 0.031$
