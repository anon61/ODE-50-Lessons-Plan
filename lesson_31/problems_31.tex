...
\textbf{Problem 11:} $\mathbf{x}(t) = e^{2t}[c$_{1}$\begin{pmatrix} 1 \\ 0 \end{pmatrix} + c$_{2}$(t\begin{pmatrix} 1 \\ 0 \end{pmatrix} + \begin{pmatrix} 0 \\ 1 \end{pmatrix})]$
...
\textbf{Problem 28:} Maximum occurs at $t = 1$ (derivative of $te^{-t}$ equals zero).
