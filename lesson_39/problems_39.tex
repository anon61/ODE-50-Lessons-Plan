...
\item Given eigenvalues $\lambda$_{1}$ = -3$, $\lambda$_{2}$ = 2$, $\lambda$_{3}$ = 1$ with eigenvectors:
$$v$_{1}$ = \begin{pmatrix} 1 \\ 0 \\ 0 \end{pmatrix}, \quad v$_{2}$ = \begin{pmatrix} 0 \\ 1 \\ 1 \end{pmatrix}, \quad v$_{3}$ = \begin{pmatrix} 0 \\ 1 \\ -1 \end{pmatrix}$$
\begin{enumerate}[label=(\alph*)]
...
\begin{enumerate}[label=(\alph*)]
    ...
    \item If $v$_{3}$ = (1,1,1)$^{T}$$, describe escape direction
