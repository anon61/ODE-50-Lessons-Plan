...
\begin{example}[2\times2 Jordan Block]
...
\begin{example}[3\times3 Nilpotent]
...
\begin{itemize}
\item If $\lambda$_{1}$ \neq \lambda$_{2}$$: $e^{At} = \frac{e^{\lambda$_{1}$ t} - e^{\lambda$_{2}$ t}}{\lambda$_{1}$ - \lambda$_{2}$}A + \frac{\lambda$_{1}$ e^{\lambda$_{2}$ t} - \lambda$_{2}$ e^{\lambda$_{1}$ t}}{\lambda$_{1}$ - \lambda$_{2}$}I$
\item If $\lambda$_{1}$ = \lambda$_{2}$ = \lambda$: $e^{At} = e^{\lambda t}[I + t(A - \lambda I)]$
\end{itemize}
\end{theorem}
