...
\begin{enumerate}[label=(\alph*)]
    \item Eigenvalues $\lambda$_{1}$ = 3, \lambda$_{2}$ = 1$
    \item Horizontal eigenvector for $\lambda$_{1}$$
    \item Vertical eigenvector for $\lambda$_{2}$$
\end{enumerate}
...
\begin{itemize}
    ...
    \item Remember: $\tau = \lambda$_{1}$ + \lambda$_{2}$$, $\Delta = \lambda$_{1}$ \cdot \lambda$_{2}$$
