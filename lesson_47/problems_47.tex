...
\item The equation $t$^{2y}$'' - 2\alpha ty' + \alpha(\alpha+1)y = 0$ has $y_{1} = t^\alpha$ as a solution.
\begin{enumerate}[label=(\alph*)]
...
$v = (c_{1} + c$_{2x}$)e$^{x}$ + c$_{3e}$^{-2x}$\\
$y = (c_{1} + c_{2}\ln t)t + \frac{c_{3}}{t^{2}}$
\end{enumerate}
...
$y'(t) = c_{1} + 2c$_{2t}$$\\
$y'(1) = c_{1} + 2c_{2} = 5$\\
Solving: $c_{2} = 2$, $c_{1} = 1$\\
Solution: $y = t + 2t^{2}$

\item From Part A #2: $y = \frac{c_{1} + c_{2}\ln t}{t}$\\
$y(1) = c_{1} = 2$\\
$y'(t) = \frac{c_{2} - c_{1} - c_{2}\ln t}{t^{2}}$\\
$y'(1) = c_{2} - c_{1} = -1$\\
$c_{2} = 1$\\
Solution: $y = \frac{2 + \ln t}{t}$

\item From Part B #8: $y = (c_{1} + c_{2}\ln t)t$\\
$y(1) = c_{1} = 0$\\
$y'(t) = c_{1} + c_{2}(1 + \ln t)$\\
$y'(1) = c_{2} = 1$\\
Solution: $y = t\ln t$

\item From Part C #11: $y = t[c_{1}\cos(2\ln t) + c_{2}\sin(2\ln t)]$\\
$y(1) = c_{1} = 1$\\
$y'(t) = [c_{1}\cos(2\ln t) + c_{2}\sin(2\ln t)] + t[-2c_{1}\sin(2\ln t)/t + 2c_{2}\cos(2\ln t)/t]$\\
$y'(1) = 1 + 2c_{2} = 2$\\
$c_{2} = \frac{1}{2}$\\
Solution: $y = t[\cos(2\ln t) + \frac{1}{2}\sin(2\ln t)]$

\item From Part A #5: $y = (c_{1} + c_{2}\ln t)t^{2}$\\
$y(2) = 4c_{1} + 4c_{2}\ln 2 = 8$\\
$y'(t) = 2(c_{1} + c_{2}\ln t)t + c$_{2t}$$\\
$y'(2) = 8c_{1} + 8c_{2}\ln 2 + 2c_{2} = 12$\\
From first: $c_{1} + c_{2}\ln 2 = 2$\\
From second: $4c_{1} + 4c_{2}\ln 2 + c_{2} = 6$\\
$c_{2} = -2$, $c_{1} = 2 + 2\ln 2$\\
