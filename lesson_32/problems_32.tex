...
\item A mass-spring system gives $\mathbf{x}' = \begin{pmatrix} 0 & 1 \\ -4 & 0 \end{pmatrix}\mathbf{x}$ where $x$_{1}$$ is position, $x$_{2}$$ is velocity. Find the frequency of oscillation.
